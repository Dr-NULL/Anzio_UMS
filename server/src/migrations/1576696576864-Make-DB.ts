...
export class MakeDB1576696576864 implements MigrationInterface {
    name = 'MakeDB1576696576864'
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TABLE "Sistema" ("id" int NOT NULL IDENTITY(1,1), "nombre" varchar(50) NOT NULL, "descripc" varchar(512) NOT NULL, "img" varbinary, "logo" varbinary, "url" varchar(248) NOT NULL, "db" varchar(128) NOT NULL, CONSTRAINT "PK_a12ba8cfb3b84749fcaf19ee20e" PRIMARY KEY ("id"))`, undefined);
        ...
        await queryRunner.query(`CREATE TABLE "Menu" ("id" int NOT NULL IDENTITY(1,1), "nombre" varchar(50) NOT NULL, "descripc" varchar(512) NOT NULL, "url" varchar(128), "icono" varchar(50) NOT NULL, "mpath" varchar(255) CONSTRAINT "DF_ce23145c2ec228a128ffb3c28db" DEFAULT '', "parentId" int, "sistemaId" int, "perfilId" int, CONSTRAINT "PK_b2683c330c5e6d700266a6f46d0" PRIMARY KEY ("id"))`, undefined);
