...
export class CreateDB1576253039496 implements MigrationInterface {
    name = 'CreateDB1576253039496'
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TABLE "IntLoad" ("id" int NOT NULL IDENTITY(1,1), "rut" varchar(15), "nombres" varchar(100), "apellido1" varchar(100), "apellido2" varchar(100), "area" varchar(100), "cargo" varchar(100), "genero" varchar(2), "fechaNacim" date, "jefeNombres" varchar(100), "jefeApellido1" varchar(100), "jefeApellido2" varchar(100), CONSTRAINT "PK_33a19cb6473d221e8c0e5e11adc" PRIMARY KEY ("id"))`, undefined);
        await queryRunner.query(`CREATE TABLE "Sistema" ("id" int NOT NULL IDENTITY(1,1), "nombre" varchar(50) NOT NULL, "descripc" varchar(512) NOT NULL, "logo" image, "url" varchar(248) NOT NULL, "db" varchar(128) NOT NULL, CONSTRAINT "PK_a12ba8cfb3b84749fcaf19ee20e" PRIMARY KEY ("id"))`, undefined);
        ...
        await queryRunner.query(`CREATE TABLE "Usuario" ("id" int NOT NULL IDENTITY(1,1), "nick" varchar(15), "pass" varchar(512), "token" varchar(512), "email" varchar(100), "isActive" bit NOT NULL CONSTRAINT "DF_24c7df5582a4e4b2d3b200c6e4d" DEFAULT 0, "rut" varchar(12) NOT NULL, "nombres" varchar(100) NOT NULL, "apellidoP" varchar(100) NOT NULL, "apellidoM" varchar(100) NOT NULL, "fechaNacim" date NOT NULL, "fechaInserc" date, "fechaElimin" date, "fechaActivac" date, "fechaDesact" date, "sexoId" int, "areaId" int, "cargoId" int, CONSTRAINT "PK_925c3fc5494373e254405c000eb" PRIMARY KEY ("id"))`, undefined);
