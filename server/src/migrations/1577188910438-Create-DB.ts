...
export class CreateDB1577188910438 implements MigrationInterface {
    name = 'CreateDB1577188910438'
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TABLE "Sistema" ("id" int NOT NULL IDENTITY(1,1), "nombre" varchar(50) NOT NULL, "descripc" varchar(512) NOT NULL, "imgType" varchar(50), "imgData" varbinary(max), "icon" varchar(20), "url" varchar(248) NOT NULL, "db" varchar(128) NOT NULL, CONSTRAINT "PK_a12ba8cfb3b84749fcaf19ee20e" PRIMARY KEY ("id"))`, undefined);
        ...
        await queryRunner.query(`CREATE TABLE "Menu" ("id" int NOT NULL IDENTITY(1,1), "nombre" varchar(50) NOT NULL, "descripc" varchar(512) NOT NULL, "url" varchar(128), "icono" varchar(50) NOT NULL, "sistemaId" int, "mpath" varchar(255) CONSTRAINT "DF_ce23145c2ec228a128ffb3c28db" DEFAULT '', "parentId" int, "perfilId" int, CONSTRAINT "PK_b2683c330c5e6d700266a6f46d0" PRIMARY KEY ("id"))`, undefined);
