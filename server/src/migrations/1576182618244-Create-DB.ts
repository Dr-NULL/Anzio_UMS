...
export class CreateDB1576182618244 implements MigrationInterface {
    name = 'CreateDB1576182618244'
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TABLE "Usuario" ("id" int NOT NULL IDENTITY(1,1), "nick" varchar(15), "pass" varchar(512), "token" varchar(512), "email" varchar(100), "isActive" bit NOT NULL CONSTRAINT "DF_24c7df5582a4e4b2d3b200c6e4d" DEFAULT 0, "rut" varchar(12) NOT NULL, "nombres" varchar(100) NOT NULL, "apellidoP" varchar(100) NOT NULL, "apellidoM" varchar(100) NOT NULL, "fechaNacim" date NOT NULL, "fechaCreac" date, "generoId" int, "relAreaCargoId" int, CONSTRAINT "PK_925c3fc5494373e254405c000eb" PRIMARY KEY ("id"))`, undefined);
        ...
        await queryRunner.query(`ALTER TABLE "Usuario" ADD CONSTRAINT "FK_2308ae5e0697abb9d2b2aa50017" FOREIGN KEY ("generoId") REFERENCES "Sexo"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`, undefined);
