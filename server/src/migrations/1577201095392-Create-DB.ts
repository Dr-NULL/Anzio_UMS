...
export class CreateDB1577201095392 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TABLE "Sistema" ("id" int NOT NULL IDENTITY(1,1), "isActive" bit NOT NULL CONSTRAINT "DF_4138445d2ead8d553b5eca671ec" DEFAULT 1, "nombre" varchar(50) NOT NULL, "descripc" varchar(512) NOT NULL, "imgType" varchar(50), "imgData" varbinary(max), "icon" varchar(20), "url" varchar(248) NOT NULL, "db" varchar(128) NOT NULL, CONSTRAINT "PK_a12ba8cfb3b84749fcaf19ee20e" PRIMARY KEY ("id"))`, undefined);
